...
export const metadata: Metadata = {
  metadataBase: new URL("https://planetamor.dev"),
  ...
  openGraph: {
    type: "website",
    url: "https://planetamor.dev",
    siteName: "Planet-A-mor",
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1605940169839-aedc047b0b06?w=1200&h=630&fit=crop&q=80",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Every $5 plants a real tree in the Peruvian Amazon — and earns you a chance to win life-changing prizes.",
    images: [
      "https://images.unsplash.com/photo-1605940169839-aedc047b0b06?w=1200&h=630&fit=crop&q=80",
    ],
  },
  other: {
    "fc:frame": "vNext",
    ...
    "fc:frame:button:1:target": "https://planetamor.dev",
  },
};
